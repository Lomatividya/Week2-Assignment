...
WebDriverManager.chromedriver().setup();
		...
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("lomatividya@gmail.com");
		...
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("LomatiVidya");
		driver.findElement(By.className("smallSubmit")).click();
